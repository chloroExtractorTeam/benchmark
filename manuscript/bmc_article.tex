...
\author[
   addressref={aff1,aff2,aff5,aff6},                   % id's of addresses, e.g. {aff1,aff2}
...
These assemblers often use data of whole genome sequencing experiments, which usually contain reads from the complete chloroplast genome.
...
The examination of \num{105} data sets from species with unknown plastid genomes led to the assembly of \num{20} novel chloroplast genomes.
...
\begin{table}[h!]
\caption{\textbf{Tools and version information used in our benchmark setup} All tools are wrapped into docker containers and stored on dockerhub \cite{dockerhub-benchmark}. The corresponding tags and SHA256 checksums are reported in \cref{tab:dockerimages_suppl}}
